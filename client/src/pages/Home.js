...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Call to Action */}
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 py-12 lg:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Start Exploring?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join the VIT-AP community and discover the best local experiences with trusted reviews and verified rentals.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center px-6 py-2 text-sm font-medium text-gray-300 hover:text-white transition-colors duration-200"
            >
